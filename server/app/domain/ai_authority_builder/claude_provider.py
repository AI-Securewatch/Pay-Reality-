...
def _build_tool_schema() -> dict:
    ...
    return {
        "name": "record_authority_graph",
        "description": "Record everything discovered about this organisation's authority structure across the whole corpus.",
        "input_schema": {
            "type": "object",
            "properties": {
...
class ClaudeAuthorityGraphExtractionProvider:
    ...
    def extract(self, corpus_text: str) -> AuthorityGraph:
        ...
        response = self._client.messages.create(
            ...
            tools=[tool],
            tool_choice={"type": "tool", "name": "record_authority_graph"},
