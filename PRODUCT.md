...
**Assurance** — a live, real-data view of what's actually running: how many agents are registered, what policy is active, how many decisions of each outcome have actually occurred. Not a governance "score" derived from a formula nobody can audit — actual counts, from the actual database.
