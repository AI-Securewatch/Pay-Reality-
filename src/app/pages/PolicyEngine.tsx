    ...
    <div className="space-y-6">
      <div>
        ...
        <p
          ...
          style={{ color: "var(--pr-text-muted)" }}
        >
          Upload delegation policies, approval matrices, SOPs, governance
          documents, and authority frameworks to automatically extract
      ...
      >
        ...
        <p
          ...
          style={{ color: "var(--pr-text-muted)" }}
        >
          Extract approval chains, authority limits, escalation rules,
          evidence requirements, and policy controls from enterprise
          documents.
        </p>
